...
class Model(object):
    ...
    def _build_model(self):
        ...
        self.predictions = tf.layers.dense(linear_inputs, self.config.nfeatures, activation=tf.nn.tanh, kernel_initializer=layers.xavier_initializer(), use_bias=False)
    ...
    def attention(self, inputs, memories):
        ...
        query = tf.layers.dense(query, self.config.attention_size, activation=None, use_bias=False,
                                ...
                                kernel_regularaizer=self.regularizer)
